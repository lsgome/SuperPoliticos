...
describe('Service Tests', () => {
    ...
    describe('LogAtualizacaoSp Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LogAtualizacaoSpService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/log-atualizacaos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LogAtualizacaoSp', () => {
