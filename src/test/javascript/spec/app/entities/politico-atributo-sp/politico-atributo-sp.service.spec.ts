...
describe('Service Tests', () => {
    ...
    describe('PoliticoAtributoSp Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PoliticoAtributoSpService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/politico-atributos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PoliticoAtributoSp', () => {
